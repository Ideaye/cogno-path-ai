    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl sm:text-2xl font-bold text-foreground">Abhyas AI</span>
            </div>
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <a href="#innovation" className="text-sm text-foreground/70 hover:text-foreground transition">Innovation</a>
            </nav>
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <Button size="sm" onClick={handleGetStarted} className="bg-primary hover:bg-primary-hover text-primary-foreground text-sm">
                Get Started
              </Button>
            </div>
          </div>
      ...
      <section className="pt-32 sm:pt-40 pb-20 sm:pb-32 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto text-center max-w-5xl">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-foreground/80 mb-8 sm:mb-12 max-w-3xl mx-auto font-normal">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button 
              ...
              className="w-full sm:w-auto bg-primary hover:bg-primary-hover text-primary-foreground text-lg px-8 py-6 h-auto transition-all hover:scale-105 font-medium"
            >
      ...
      <section id="features" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="container mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-foreground/80 max-w-2xl mx-auto font-normal">
          ...
          <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
            <GlassCard className="p-4 sm:p-6 group hover:shadow-md transition-all animate-fade-in">
              ...
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-foreground">AI-Driven Calibration</h3>
            ...
            <GlassCard className="p-4 sm:p-6 group hover:shadow-md transition-all">
              ...
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-foreground">Adaptive Practice</h3>
              <p className="text-sm sm:text-base text-foreground/70 leading-relaxed font-normal">
            ...
            <GlassCard className="p-4 sm:p-6 group hover:shadow-md transition-all">
              ...
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-foreground">Cognitive Insights</h3>
              <p className="text-sm sm:text-base text-foreground/70 leading-relaxed font-normal">
            ...
            <GlassCard className="p-4 sm:p-6 group hover:shadow-md transition-all">
              ...
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-foreground">Real-Time Feedback</h3>
              <p className="text-sm sm:text-base text-foreground/70 leading-relaxed font-normal">
            ...
            <GlassCard className="p-4 sm:p-6 group hover:shadow-md transition-all">
              ...
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-foreground">Progress Tracking</h3>
              <p className="text-sm sm:text-base text-foreground/70 leading-relaxed font-normal">
            ...
            <GlassCard className="p-4 sm:p-6 group hover:shadow-md transition-all">
              ...
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-foreground">Smart Reviews</h3>
              <p className="text-sm sm:text-base text-foreground/70 leading-relaxed font-normal">
      ...
      <section id="innovation" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-6 sm:mb-8 text-foreground">
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="space-y-6 sm:space-y-8">
            <GlassCard className="p-4 sm:p-6 flex flex-col sm:flex-row items-start gap-4 sm:gap-6 hover:shadow-md transition-all">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-semibold mb-2 sm:mb-3 text-foreground">Calibrate Your Baseline</h3>
            ...
            <GlassCard className="p-4 sm:p-6 flex flex-col sm:flex-row items-start gap-4 sm:gap-6 hover:shadow-md transition-all">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-semibold mb-2 sm:mb-3 text-foreground">Practice Adaptively</h3>
                <p className="text-sm sm:text-base text-foreground/70 font-normal">
            ...
            <GlassCard className="p-4 sm:p-6 flex flex-col sm:flex-row items-start gap-4 sm:gap-6 hover:shadow-md transition-all">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-semibold mb-2 sm:mb-3 text-foreground">Track & Excel</h3>
                <p className="text-sm sm:text-base text-foreground/70 font-normal">
        ...
        <div className="container mx-auto text-center max-w-4xl">
          <GlassCard className="p-6 sm:p-8 md:p-10">
            ...
            <Button 
              size="lg" 
              onClick={handleGetStarted}
              className="bg-primary hover:bg-primary-hover text-primary-foreground text-lg px-8 sm:px-12 py-6 h-auto transition-all hover:scale-105 font-medium"
            >
              Start Learning Today
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-foreground">Abhyas AI</span>
            </div>
            <p className="text-sm text-foreground/70 text-center sm:text-left">
              © 2025 Abhyas AI. Empowering learners worldwide.
            </p>
            <div className="flex items-center gap-6">
              <a href="#" className="text-sm text-foreground/70 hover:text-foreground transition">Privacy</a>
              <a href="#" className="text-sm text-foreground/70 hover:text-foreground transition">Terms</a>
              <a href="#" className="text-sm text-foreground/70 hover:text-foreground transition">Contact</a>
            </div>
          </div>
        </div>
      </footer>
